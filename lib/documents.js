...
function Paragraph(children, properties) {
    // console.log('documents--Paragraph', properties)
...
function Run(children, properties) {
    ...
    return {
        ...
        color: properties.color || null, // [Moore] add fontColor
        highlight: properties.highlight || null // [Moore] add highlight
    };
}
...
function Image(options) {
    return {
        ...
        extent: options.extent // [Moore] add image size
    };
}
