...
function DocumentConversion(options, comments) {
    ...
    function convertToHtml(document) {
        ...
        return promises.mapSeries(deferredNodes, function(deferred) {
            ...
            const res = new results.Result(writer.asString(), messages, documentInfo)
            console.log('document-to-html---convertToHtml', res)
            return res
        });
    }
    ...
    function convertParagraph(element, messages, options) {
        if (element.pageInfo) {
            ...
            console.log('document-to-html---element.pageInfo', element.pageInfo)
        }
    ...
    function htmlPathForParagraph(element, messages) {
        ...
        console.log('document-to-html---htmlPathForParagraph', style)
    ...
    function convertRun(run, messages, options) {
        ...
        // [Moore] add backgroundColor
        if (run.highlight) {
            styleStr += `background-color:${run.highlight};`;
        }
        // [Moore] add font-family
        if (run.font) {
            styleStr += `font-family:${run.font};`;
        }
        // [Moore] add font-size
        if (run.fontSize) {
        ...
        if (styleStr) {
            paths.push(htmlPaths.element('span', { style: styleStr }, {fresh: false}));
        }
    ...
    function findStyle(element) {
        // console.log('document-to-html---styleMap', styleMap)
    ...
    // [Moore] add pageInfo
    function convertPage(element, message, options) {
        documentInfo.pageInfo = element.properties
        return []
    }
    ...
    var elementConverters = {
        ...
        "break": convertBreak,
        "page": convertPage // [Moore] add pageInfo
    };
    return {
